...
export const useFriendsStore = create<FriendsState & FriendsActions>((set, get) => ({
  ...
  acceptFriendRequest: async (requestId: string) => {
    ...
    set({ loading: true });
    try {
      console.log(`🔄 [FRIENDS] Accepting friend request ${requestId} for user ${user.id}`);
      ...
      console.log(`🔄 [FRIENDS] Request accepted successfully:`, data);
      
      // Rimuovi immediatamente dalla lista delle richieste in attesa
      set(state => ({
      ...
      toast({ title: 'Richiesta accettata', description: 'Ora siete amici!' });
    } catch (error: any) {
  ...
  declineFriendRequest: async (requestId: string) => {
    ...
    set({ loading: true });
    try {
      console.log(`🔄 [FRIENDS] Declining friend request ${requestId} for user ${user.id}`);
      ...
      console.log(`🔄 [FRIENDS] Request declined successfully:`, data);
      ...
      toast({ title: 'Richiesta rifiutata', description: 'La richiesta è stata rimossa' });
    } catch (error: any) {
